...
@Component({
  ...
  imports: [LightgalleryModule, ItemCardComponent, NgOptimizedImage],
})
    ...
    directive: {
      ...
      members: [
        ...
        },
        {
          title: 'Miguel Anta',
          description:
            'Vicepresidente y contacto con la <a href="https://femecv.com/" target="_blank" aria-label="Federación de Deportes de Montaña y Escalada de la Comunidad Valenciana">FEMECV</a>',
