...
>
  <div class="flex-shrink-0 mb-4 mb-sm-0 me-sm-4">
    ...
    >
      ...
      />
      @if (hasImage) {
        <div class="zoom-icon position-absolute top-50 start-50 translate-middle opacity-0 transition-all">
  ...
  styles: [`
    ...
    .rounded-circle:hover .zoom-icon { opacity: 1 !important; }
    .rounded-circle:hover img { filter: brightness(0.8); }
  `]
})
